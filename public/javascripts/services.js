app.service('imgService', function($http, $resource) {
 return {
  ...
  getMedia: function(userID) {
    var instaApi = $resource(
     `https://api.instagram.com/v1/users/${userID}/media/recent/?access_token=4147147144.7158948.cf207a8f4c434dad81498b84ba2ca48d&count=10`, {
      callback: 'JSON_CALLBACK'
     }, {
      getInstaData: { // call this in the controller
       method: 'JSONP',
